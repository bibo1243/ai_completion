...
export const COLOR_THEMES: Record<string, ThemeColor> = {
  ...
  coder: { color: '#78716c', bg: 'bg-[#fafaf9]', text: 'text-[#57534e]', accent: 'text-[#57534e]', badge: 'bg-[#f5f5f4] text-[#57534e] border-[#e7e5e4]', border: 'border-[#78716c]', ring: 'focus-within:ring-[#e7e5e4]', buttonRing: 'focus:ring-[#e7e5e4] focus:border-[#d6d3d1]', dot: 'bg-[#a8a29e]', breadcrumb: 'bg-[#fafaf9] text-[#57534e] hover:bg-[#f5f5f4]', indicator: 'bg-[#78716c]', ringColor: 'ring-[#a8a29e]' },
};
